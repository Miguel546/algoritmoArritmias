...
% Last Modified by GUIDE v2.5 31-Jul-2019 12:44:11
...
fs = 360;
[ecgnormal, ecg, Rindex, Q_index, S_index, K_index, anotacion, locs, ecg_hplot, ecg_dplot, ecg_splot, ecg_mplot, qrs_i, qrs_c, NOISL_buf, SIGL_buf, THRS_buf] = detectarPuntoR(conexionBD, registromit, seleccionarRegistro, fs, 0);
gr = 1;
figure,
if gr
ax(1)=subplot(3,2,[1 2]);plot(ecg);axis tight;title('Senal ECG');
end
if gr
