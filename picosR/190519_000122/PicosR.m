...
fs = 360;
[ecg, Rindex, anotacion] = detectarPuntoR(registromit, seleccionarRegistro, fs, 0);
...
hold on,plot(Rindex,ecg(Rindex),'r*');
...
copyfile('pan_tompkin_gui.m',strcat('picosR/',fechahora, '/', 'pan_tompkin_gui.m'));
copyfile('pan_tompkin.m', strcat('picosR/',fechahora, '/', 'pan_tompkin.m'));
...
datainsert(conn, 'picosr', nombresCol, dataInsertar);
