function [ecg, ecgs, Rindex, Q_index, S_index, K_index, anotacion, locs, ecg_hplot, ecg_dplot, ecg_splot, ecg_mplot, qrs_i, qrs_c, NOISL_buf, SIGL_buf, THRS_buf] = detectarPuntoR(conexionBD, registromit, numero, fs, gr)
