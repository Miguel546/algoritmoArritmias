...
if gr
title('Hola');
ax(1)=subplot(3,2,[1 2]);plot(ecg);xlabel('Tiempo(muestras)');ylabel('Amplitud(mV)');axis tight;title(strcat('Senal ECG ', {' '}, registromit));
end
if gr
ax(3)=subplot(323);plot(ecg_hplot);xlabel('Tiempo(muestras)');ylabel('Amplitud(mV)');axis tight;title('Filtro pasa banda');
end
if gr
ax(4)=subplot(324);plot(ecg_dplot);xlabel('Tiempo(muestras)');ylabel('Amplitud(mV)');axis tight;title('Derivación después del filtrado');
end
if gr
ax(5)=subplot(325);plot(ecg_splot);xlabel('Tiempo(muestras)');ylabel('Amplitud(mV)');axis tight;title('Elevar al cuadrado');
end
if gr
ax(6)=subplot(326);plot(ecg_mplot);xlabel('Tiempo(muestras)');ylabel('Amplitud(mV)');axis tight;title('Promedio con 30 muestras,Ruido negro,Umbral verde adaptativo,Rojo Nivel de la señal,Círculos Rojos QRS detectados');
axis tight;
end
if gr
...
if gr
   ...
   az(2)=subplot(312);plot(ecg_mplot);;xlabel('Tiempo(muestras)');ylabel('Amplitud(mV)');
