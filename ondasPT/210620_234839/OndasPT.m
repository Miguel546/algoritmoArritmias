...
hold on, plot(ecgnormal,'b');
hold on, plot(ecgnormal, block,'k.-');
hold on, plot(Rindex,ecgnormal(Rindex),'go');
hold on, plot(Tindex,ecgnormal(Tindex),'k+');
hold on, plot(Pindex,ecgnormal(Pindex),'r*');
