...
queriesArr(9) = "SELECT * FROM mitarrythmiadatabase.anotaciones108m where `Type` <> '~' and `Type` <> 'x' and `Type` <> '|';";
queriesArr(10) = "SELECT * FROM mitarrythmiadatabase.anotaciones109m where `Type` <> '~';";
queriesArr(11) = "SELECT * FROM mitarrythmiadatabase.anotaciones111m where `Type` <> '~';";
queriesArr(12) = "SELECT * FROM mitarrythmiadatabase.anotaciones112m where `Type` <> '~';";
queriesArr(13) = "SELECT * FROM mitarrythmiadatabase.anotaciones113m;";
...
queriesArr(18) = "SELECT * FROM mitarrythmiadatabase.anotaciones118m where `Type` <> 'x' and `Type` <> '~';";
...
queriesArr(25) = "select * from mitarrythmiadatabase.anotaciones201m where type <> '~' and type <> 'x';";
queriesArr(26) = "select * from mitarrythmiadatabase.anotaciones202m where type <> '|';";
queriesArr(27) = "select * from mitarrythmiadatabase.anotaciones203m where type <> '~' and type <> '|' and type <> 'Q';";
...
%    queriesArr(45) = queriesArr(45) +querie231(i);
%end
