...
[NSyR, SyBr, AtFl, AtFib, VTa, VFl, OtraArritmia, Resultados]= detectarArritmias(conexionBD, registromit, numero, ecgs2, fs, Rindex2, Pindex, P_ON_index, S_index, Q_index, Tindex, K_index);
[conexionBD] = conexion(dbname, username, password, driver, dburl);
...
data=xlsread('DeteccionArritmiasTotal.xlsx','Hoja1', 'C:C');  % read the column of interest
row=length(data)+1;
