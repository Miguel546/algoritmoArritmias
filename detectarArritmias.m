       ...
       %El ancho del QRS en ms
        ...
        if(60/(RR(i-1)/fs)<55)
                    ...
                    if(RitmoR && latnormal && PRint == 1 && hayondaP && normalqrs)
                        ...
                        contNSyR = contNSyR + 1;
                        Resultados{i,1} = registromit;
                        Resultados{i,2} = Rindex(i);
                        Resultados{i,3} = PRmsRegistro(i);
                        Resultados{i,4} = QRSmsRegistro(i);
                        Resultados{i,5} = RitmoCardiacoRegistro(i);
                        Resultados{i,6} = HayOndaPRegistro(i);
                        Resultados{i,7} = desviacion(i);
                        Resultados{i,8} = {'(N'};
            ...
            if(i == diezSegundosMuestra)
                for j=1 : diezSegundosMuestra
                    ...
                    if(RitmoR && latnormal && PRint == 1 && hayondaP && normalqrs)
                        ...
                        contNSyR = contNSyR + 1;
                        Resultados{j,1} = registromit;
                        Resultados{j,2} = Rindex(j);
                        Resultados{j,3} = PRmsRegistro(j);
                        Resultados{j,4} = QRSmsRegistro(j);
                        Resultados{j,5} = RitmoCardiacoRegistro(j);
                        Resultados{j,6} = HayOndaPRegistro(j);
                        Resultados{j,7} = desviacion(j);
                        Resultados{j,8} = {'(N'};
                    elseif(RitmoR && bradi && PRint == 1 && hayondaP && normalqrs)
                        SyBr{contSyBr,1} = registromit;
